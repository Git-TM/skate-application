...
spot1.photo.attach(io: file1, filename: "nations", content_type: 'image/jpg')
...
spot2.photo.attach(io: file2, filename: "palaistokyo", content_type: 'image/jpg')
...
spot3.photo.attach(io: file3, filename: "charonne", content_type: 'image/jpg')
