...
file1 = URI.open("https://upload.wikimedia.org/wikipedia/commons/2/21/Palais_de_Tokyo_-_Skate_02.jpg")
spot2photo1.photo.attach(io: file1, filename: "palaistokyo", content_type: 'image/jpg')
file2 = URI.open("https://i.skyrock.net/1855/13321855/pics/338019979_small.jpg")
spot2photo2.photo.attach(io: file2, filename: "palaistokyo", content_type: 'image/jpg')
spot2photo1.save!
spot2photo2.save!
spot2.save!
